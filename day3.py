...
def add_points(start, instruction, points):
	move_val = int(instruction[1:])
	if instruction[0] == 'U':
		for x in range(move_val):
			points.add((start[0], start[1]+x))
		return (start[0], start[1]+move_val)
	elif instruction[0] == 'R':
		for x in range(move_val):
			points.add((start[0]+x, start[1]))
		return (start[0]+move_val, start[1])
...
def place_paths(line1, line2):
	...
	for instruction1 in line1:
		start = add_points(start, instruction1, line1_points)

	start = (0,0)
	for instruction2 in line2:
		start = add_points(start, instruction2, line2_points)

	return line1_points.intersection(line2_points)
...
def find_distance(line1, line2):
	paths = place_paths(line1, line2)
	return get_closest(paths)
